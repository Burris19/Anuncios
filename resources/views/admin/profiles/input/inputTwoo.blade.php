<fieldset>
    ...
    <div class="row">
        <div class="row col-md-6">
            ...
            <div class="col-md-8">
                <input type="text" class="form-control name"  name="name2" placeholder="Valentina Perez"  >
            </div>
        </div>
        <div class="row col-md-6">
            <label class="col-md-4 control-label" for="profileAge">{!! trans('label.age_profile') !!}</label>
            <div class="col-md-8">
                <input type="text" class="form-control age" name="age2"  placeholder="22"  >
            </div>
        </div>
    </div>
    <br>
        ...
        <div class="row col-md-6">
            ...
            <div class="col-md-8">
                ...
                <span class="input-group-addon">
                    ...
                    <input type="text" class="form-control phone" placeholder="111 111 111" name="phone2"  >
                </div>
            </div>
        </div>
        <div class="row col-md-6">
            ...
            <div class="col-md-8">
                <input type="text" class="form-control measurements"  name="measurements2" placeholder="90-60-90"  >
            </div>
        </div>
    </div>
    <br>
    ...
    <div class="row">
        <div class="row col-md-6">
            ...
            <div class="col-md-8">
                <input type="text" class="form-control height"  name="height2" placeholder="165"  >
            </div>
        </div>
        <div class="row col-md-6">
    ...
    <div class="row">
        <div class="row col-md-6">
            ...
            <div class="col-md-8">
                <input type="text" class="form-control price" name="price2" placeholder="125">
            </div>
        </div>
        <div class="row col-md-6">
